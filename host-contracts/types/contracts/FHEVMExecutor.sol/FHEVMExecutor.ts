...
export interface FHEVMExecutorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "HANDLE_VERSION"
...
export interface FHEVMExecutor extends BaseContract {
  connect(runner?: ContractRunner | null): FHEVMExecutor;
  waitForDeployment(): Promise<this>;

  interface: FHEVMExecutorInterface;
